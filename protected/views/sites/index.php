                                ...
                                <td>
                                    <div class="am-btn-toolbar">
                                        <div class="am-btn-group am-btn-group-xs">
                                            <a href="<?php echo $this->createUrl('affiliates/edit',array('id'=>$site['id']))?>" class="btn btn-outline btn-primary" ><span class="am-icon-pencil-square-o"></span> Edit</a>
                                            <?php if(in_array($this->user['groupid'],$this->manager_group)){ ?>
                                                <button onclick="deletesite(<?php echo $site['id']?>)" class="btn btn-outline btn-warning" ><span class="am-icon-trash-o"></span> Delete</button>
                                            <?php } ?>
                                        </div>
                                    </div>
                                </td>
