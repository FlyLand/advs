...
<div class="admin-content">
        <div class="am-cf am-padding">
            <div class="am-fl am-cf">
                <strong class="am-text-primary am-text-lg">Edit: Offer Whitelist</strong>
            </div>
        </div>
        ...
        <div class="am-panel-bd am-collapse am-in" id="collapse-panel-1">
            <form name="edit_form" id="edit_form" action="<?php echo $this->createUrl('offer/whitelistedit', array('offerid'=>$data['offerid'], 'id'=>$data['id']));?>" method="post">
            <div class="am-g am-margin-top">
                <div class="am-u-sm-4 am-u-md-2 am-text-right">OfferID:</div>
                <div class="am-u-sm-8 am-u-md-10"><?php echo isset($data['offerid']) ? $data['offerid'] : '';?></div>
            </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-8 am-u-md-10">
                    <select name="content_type" id="content_type" data-am-selected="{btnWidth: 300, btnSize: 'sm', btnStyle: 'secondary'}" style="display: none;">
                        <option value="1" <?php if(isset($data['ip_info']['content_type']) && 1 == $data['ip_info']['content_type']){?>selected<?php }?> >IP Address</option>
                    </select>
                </div>
            </div>
            ...
            <div class="am-g am-margin-top">
                ...
                <div class="am-u-sm-8 am-u-md-4 am-u-end col-end">
        			<input type="text" class="am-input-sm" name="content" id="content" value="<?php echo isset($data['ip_info']['content']) ? $data['ip_info']['content'] : '';?>" />
        		</div>
            </div>
            
            <div class="am-margin">
            	<input type="hidden" name="offerid" id="offerid" value="<?php echo isset($data['offerid']) ? $data['offerid'] : '';?>" />
