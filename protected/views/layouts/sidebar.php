<?php
//计算当前选择大栏
$powerinfo = Yii::app()->user->getState('powerinfo');
//读取offer是否为推荐
						...
						<div class="dropdown profile-element">
							...
							<a data-toggle="dropdown" class="dropdown-toggle" href="#">
								<span class="clear"><span class="block m-t-xs"><strong class="font-bold"><?php echo Yii::app()->user->name;?></strong></span>
									<?php if(!empty(Yii::app()->user->getState('groupid'))){ ?>
								<span class="text-muted text-xs block"><?php echo Yii::app()->params['systemGroup'][Yii::app()->user->getState('groupid')]?><b class="caret"></b></span></span>
								<?php } ?>
							</a>
							<ul class="dropdown-menu animated fadeInRight m-t-xs">
								<li><a class="J_menuItem" href="<?php echo Yii::app()->createUrl('user/user/list')?>">修改头像</a>
								</li>
