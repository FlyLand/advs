...
jQuery.fn.ingrid = function(o){
	...
	var cfg = {
		...
		/* sorting */
		sorting: false,
		colSortParams: ['id'],						// value to pass as sort param when header clicked (i.e. '&sort=param') ex: ['col1','col2','col3','col4']
		...
		sortedCol: '',						// current data's sorted column (can be a key from 'colSortParams', or an int 0-n (for n columns)
